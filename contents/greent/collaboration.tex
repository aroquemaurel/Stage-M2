...
%
%\subsubsection{Les cas d'utilisation}
%Comme on peut le voir, la fonctionnalité qui peut paraître simple au premier abord possède un grand nombre de cas d'utilisation. 
%\begin{figure}[H]
%\centering
%\includegraphics[width=18cm]{contents/images/arrayUseCase.jpg}
