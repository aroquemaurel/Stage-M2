...
\begin{description} 
	...
	\item[Informations aidant à la conversion des données] Certains équipements\footnote{Vous trouverez plus d'informations sur le fonctionnement d'une table de tests section \ref{wb}, et dans l'annexe \ref{devices}} tel que le \textit{debgger} ne fonctionne qu'avec des
...
\end{figure}
\section{Le fonctionnement Global}
